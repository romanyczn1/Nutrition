...
class CurveAlgorithm {
    ...
    private func controlPointsFrom(points: [CGPoint]) -> [CurvedSegment] {
        ...
        let delta: CGFloat = 0.4 // The value that help to choose temporary control points.
        ...
        for i in 1..<points.count-1 {
            ...
            result[i].controlPoint1 = CGPoint(x: MM.x, y: A.y)
            result[i-1].controlPoint2 = CGPoint(x: NN.x, y: A.y)
